          ...
          <Col smOffset={2} sm={8} mdOffset={2} md={8}>
            <div id="about_container">
              <Jumbotron className="about">
                <div id="about_info">Mathtronaut is an<a className="aboutlink" target="_blank" href="https://github.com/galvinma/mathtronaut">open source</a> space themed website designed to make learning mathmatics fun.</div>
                <br />
